...
class Server
{
    ...
    Server()
    {
        _messageProcessor = new MessageProcessorBuilder()
            ...
            .Bind<SynchronizationChatsMessage, SynchronizationChatsMessageHandler>()
            .Bind<SynchronizationChatMessage, SynchronizationChatMessageHandler>()
            ...
            .Bind<GetChatMessage, GetChatMessageHandler>()
